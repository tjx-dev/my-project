...
#map(函数，对象)=[x*2 for x in nums] 负责处理,加工函数
# c=[2]
# def fin(a):
#     return a**5
# print(list(map(fin,c)))

#filter=[x for x in nums if x>10] 表示判断 符合返回具体值 筛选
# a=[1,2]
# app=lambda x:x%2==0
...
#reduce 在元素里面取俩个计算，在把结果和下一个进行计算 递加
#先导入 functools
...
#     print(e)
    ...
    #没有异常
    #print("结果")
#NameError,ZeroDiveSionError,IndexError,
